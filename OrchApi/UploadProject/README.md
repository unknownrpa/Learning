...
| contentLength	| integer	| ContentLength передаваемый в заголовке http на загрузку файла. Совместно с FileSize используется для определения процента загрузки
