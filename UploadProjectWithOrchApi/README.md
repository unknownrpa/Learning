...
Упаковать проект в zip-файл можно средствами Студии или самостоятельно. Для упаковки в Студии ознакомьтесь с инструкцией [Публикация проекта](https://github.com/PrimoRPA/Docs.Rus/blob/main/primo-studio/projects/publish.md).
