...
| noDuplicateDeferredQueue | boolean	| Не повторять в очереди проектов. Если проект уже находится в очереди ожидания, он туда не добавится повторно. <p>Возможные значения:</p><p>•	true – не повторять;</p><p>•	false – повторять</p>
| fileId	| string	| GUID архива проекта
